        ...
        <ul class="dropdown-menu" aria-labelledby="categoryDropdown">
          ...
          <template v-if="filteredCategories.length > 0">
            <li
              ...
              @click="filterByCategory(category.nama_kategori)"
              class="dropdown-item"
            >
  ...
  watch: {
    categories: {
      ...
      handler(newCategories) {
        console.log("Updated categories in CategoryFilter:", newCategories);
  ...
  methods: {
    ...
    filterCategories() {
      this.filteredCategories = this.categories.filter((category) =>
        category.nama_kategori.toLowerCase().includes(this.searchQuery.toLowerCase())
      );
