...
export default {
  data() {
    return {
      book: {
        ...
        penerbit: "",
        stok: "",
        kategori: "", // ID kategori yang dipilih
  ...
  methods: {
    ...
    async submitForm() {
      ...
      // Pastikan kategori diisi dan valid
      if (this.book.kategori) {
        formData.append("kategori_id", this.book.kategori); // Ganti nama parameter menjadi kategori_id
      } else {
      ...
      formData.append("_method", "PUT"); // Tambahkan _method untuk mengubah menjadi PUT
